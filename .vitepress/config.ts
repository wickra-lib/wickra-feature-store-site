...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'Organization',
      '@id': 'https://feature-store.wickra.org/#organization',
      name: 'Wickra',
      url: 'https://feature-store.wickra.org/',
      logo: 'https://feature-store.wickra.org/wickra-mark.svg',
      sameAs: [
        'https://github.com/wickra-lib/wickra-feature-store',
    ...
    },
    {
      ...
      '@id': 'https://feature-store.wickra.org/#software',
      ...
      description:
        'Turn OHLCV and microstructure event streams into ML-ready feature matrices over 514 streaming indicators, in ten languages. Built on the Wickra core.',
      license: 'https://github.com/wickra-lib/wickra-feature-store#license',
      publisher: { '@id': 'https://feature-store.wickra.org/#organization' },
    },
  ],
}

export default defineConfig({
  title: 'Wickra Feature Store',
  description:
    'Turn OHLCV and microstructure event streams into ML-ready feature matrices over 514 streaming indicators, in ten languages. Built on the Wickra core.',
  lang: 'en-US',
  cleanUrls: true,

  // Served at the domain root (feature-store.wickra.org via Cloudflare Pages).
  base: '/',

  sitemap: { hostname: 'https://feature-store.wickra.org' },
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Wickra Feature Store — ML-ready feature matrices from market data' }],
    [
      'meta',
      {
        property: 'og:description',
        content:
          'One FeatureSpec folded over 514 streaming indicators into a feature/label matrix, in ten languages. Deterministic and byte-identical across every binding.',
      },
    ],
    ['meta', { property: 'og:image', content: 'https://feature-store.wickra.org/og-banner.webp' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://feature-store.wickra.org/og-banner.webp' }],
    ['script', { type: 'application/ld+json' }, JSON.stringify(structuredData)],
  ],

  transformPageData(pageData) {
    const path = pageData.relativePath.replace(/(?:index)?\.md$/, '')
    const canonical = `https://feature-store.wickra.org/${path}`
  ...
  themeConfig: {
    siteTitle: 'Wickra Feature Store',
    logo: { src: '/wickra-mark.svg', alt: 'Wickra Feature Store' },
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/wickra-lib/wickra-feature-store' },
      {
        text: 'Links',
        items: [
          { text: 'crates.io', link: 'https://crates.io/crates/wickra-feature-store' },
          { text: 'PyPI', link: 'https://pypi.org/project/wickra-feature-store/' },
          { text: 'npm', link: 'https://www.npmjs.com/package/wickra-feature-store' },
          { text: 'NuGet', link: 'https://www.nuget.org/packages/Wickra.FeatureStore' },
          { text: 'Maven Central', link: 'https://central.sonatype.com/artifact/org.wickra/wickra-feature-store' },
          { text: 'Go module', link: 'https://pkg.go.dev/github.com/wickra-lib/wickra-feature-store-go' },
      ...
      },
      {
        text: 'v0.1.1',
        items: [
          { text: 'Release notes', link: 'https://github.com/wickra-lib/wickra-feature-store/releases' },
          { text: 'Changelog', link: 'https://github.com/wickra-lib/wickra-feature-store/blob/main/CHANGELOG.md' },
          { text: 'docs.rs', link: 'https://docs.rs/wickra-feature-store/latest/wickra_feature_store/' },
        ],
      },
      {
        text: 'Ecosystem',
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/wickra-lib/wickra-feature-store' }],
