...
[![Built on Wickra](https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-feature-store-site/built-on.svg)](https://github.com/wickra-lib/wickra)
[![Docs](https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-feature-store/docs.svg)](https://feature-store.wickra.org)
...
[![Built with VitePress](https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-feature-store-site/vitepress.svg)](https://vitepress.dev)

---

Source for the Wickra Feature Store site (**[feature-store.wickra.org](https://feature-store.wickra.org)**): hero, per-language API overviews, benchmarks and the in-browser indicator demo.
...
**Wickra Feature Store** — OHLCV and microstructure streams into ML-ready feature matrices over the 514 O(1) streaming indicators. The library itself is
[`wickra-lib/wickra-feature-store`](https://github.com/wickra-lib/wickra-feature-store); its README carries the install line and a quick start for every language.
...
- **The released version** — the version menu in the nav, the Maven snippet on the landing page and the Java API page — is pulled hourly from [wickra-feature-store's latest release](https://github.com/wickra-lib/wickra-feature-store/releases/latest) by `sync-from-feature-store.yml`.
...
Custom domain `feature-store.wickra.org` is configured in the Cloudflare Pages dashboard.
