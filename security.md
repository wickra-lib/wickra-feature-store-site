...
- GitHub → the [wickra-feature-store repository](https://github.com/wickra-lib/wickra-feature-store)
...
Wickra Feature Store parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-feature-store/blob/main/SECURITY.md)
